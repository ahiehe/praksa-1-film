...
public interface IFilmService
{
    ...
    public Task<ServiceResult<List<FilmOptionDTO>>> GetFilmOptionsAsync();
    public Task<ServiceResult<Film>> GetFilmByIdAsync(int id);
    public Task<ServiceResult<int>> CreateFilmAsync(CreateFilmDTO dto);
    public Task<ServiceResult> UpdateFilmAsync(int id, CreateFilmDTO dto);
